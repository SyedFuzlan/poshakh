  ...
  return (
    <section className="relative w-full h-[60vh] overflow-hidden my-20">
      ...
      <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center px-4">
        <span className="text-zohra-gold font-body tracking-[0.3em] font-semibold text-sm mb-4">
        ...
        <Link 
          ...
          className="bg-zohra-cream text-zohra-charcoal px-10 py-4 font-heading tracking-widest font-bold hover:bg-zohra-gold hover:text-white transition-colors"
        >
          EXPLORE
        </Link>
      </div>
